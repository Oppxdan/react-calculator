    ...
    return (
        <div className="calculator">
            ...
            <section className="calc-grid">
                ...
                <button className="calc-btn" onClick={() => props.addNumber("/")}>/</button> 
                ...
                <button className="calc-btn" onClick={() => props.addNumber("*")}>X</button> 
                ...
                <button className="calc-btn" onClick={() => props.addNumber("+")}>+</button> 
                <button className="calc-btn" onClick={props.backspace}>⌫</button>
                <button className="calc-btn" onClick={props.clear}>C</button>  
            </section>
        </div>
    )
}
